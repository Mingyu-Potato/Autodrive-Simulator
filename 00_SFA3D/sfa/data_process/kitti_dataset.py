...
class KittiDataset(Dataset):
    ...
    def get_lidar(self, idx):
        lidar_file = os.path.join(self.lidar_dir, f'{idx}.pcd')
    ...
    def get_label(self, idx):
        labels = []
        label_path = os.path.join(self.label_dir, f'{idx}.json')
...
if __name__ == '__main__':
    ...
    for idx in range(len(dataset)):
        bev_map, labels, sample_id = dataset.draw_img_with_label(idx)
